    ...
    renderMain = () => {
        ...
        return (
                <Box display="flex" flexDirection="column" alignItems="center"> 
                    <Box p={1}><h3>Log in to your account</h3></Box>
                    <Box p={1}><TextField label="Email" variant="filled" onChange={this.handleEmailChange} /></Box>
                    <Box p={1}><TextField type="password" label="Password" variant="filled" onChange={this.handlePasswordChange} onKeyDown={this.handlePasswordKeydown} /></Box>
                    <Box><Button onClick={this.login} variant="contained">Log in</Button></Box>
                    <Box p={1}><h3>Don't have an account? Sign up HERE</h3></Box>
                </Box>)
    }
    ...
    render(){
        ...
        <StyledWrapper>
            <Box display="flex" mb={1}>
                {this.state.isAuthenticated && (<button onClick={()=> this.onLogout()}>Log out</button>)}
