...
definitions = {'definitions': {'error': {'type': 'object', 'properties': {'errorMessage': {'type': 'string', 'example': 'error message'}}}, 'tag': {'type': 'object', 'properties': {'tag': {'type': 'string', 'example': 'comedy'}, 'user_id': {'type': 'integer', 'example': 1}}}, 'note': {'type': 'object', 'properties': {'note_id': {'type': 'integer', 'example': 1}, 'note': {'type': 'string', 'example': 'this is my note'}, 'user_id': {'type': 'integer', 'example': 1}, 'video_id': {'type': 'string', 'example': 'gSdG3FsMBq4'}, 'timestamp': {'type': 'number', 'example': 2.5}, 'time_created': {'type': 'integer', 'example': 1573010015}, 'last_edited': {'type': 'integer', 'example': 1573010015}}}, 'video': {'type': 'object', 'properties': {'video_id': {'type': 'string', 'example': 'gSdG3FsMBq4'}, 'user_id': {'type': 'integer', 'example': 1}, 'video_title': {'type': 'string', 'example': 'physics 101'}, 'categories': {'type': 'string', 'example': 'comedy'}, 'time_created': {'type': 'integer', 'example': 1573010015}, 'last_edited': {'type': 'integer', 'example': 1573010015}, 'notes_ids': {'type': 'array', 'items': {'type': 'integer'}, 'example': [1, 4, 17]}, 'notes_count': {'type': 'integer', 'example': 3}}}}, 'parameters': {}}

validators = {
    ('logout', 'DELETE'): {'headers': {'required': ['Authorization'], 'properties': {'Authorization': {'type': 'string'}}}},
    ('login', 'POST'): {'json': {'type': 'object', 'properties': {'email': {'type': 'string', 'example': 'mitchell_shelton@y7mail.com'}, 'password': {'type': 'string', 'example': 'secret'}}}},
    ('createAccount', 'POST'): {'json': {'type': 'object', 'properties': {'email': {'type': 'string', 'example': 'mitchell_shelton@y7mail.com'}, 'password': {'type': 'string', 'example': 'secret'}}}},
    ('notes', 'GET'): {'headers': {'required': ['Authorization'], 'properties': {'Authorization': {'type': 'string'}}}, 'args': {'required': [], 'properties': {'sort': {'type': 'string', 'enum': ['+note_id', '+note', '+user_id', '+video_id', '+timestamp', '+time_created', '+last_edited', '-note_id', '-note', '-user_id', '-video_id', '-timestamp', '-time_created', '-last_edited'], 'default': '+timestamp'}, 'note_id': {'type': 'integer'}, 'video_id': {'type': 'string'}, 'user_id': {'type': 'integer'}, 'timestamp': {'type': 'number'}, 'note': {'type': 'string'}, 'time_created': {'type': 'integer'}, 'last_edited': {'type': 'integer'}}}},
    ('notes', 'POST'): {'json': {'type': 'object', 'properties': {'note': {'type': 'string', 'example': 'this is my note'}, 'user_id': {'type': 'integer', 'example': 1}, 'video_id': {'type': 'string', 'example': 'gSdG3FsMBq4'}, 'video_title': {'type': 'string', 'example': 'How to code'}, 'timestamp': {'type': 'number', 'example': 2.5}}}, 'headers': {'required': ['Authorization'], 'properties': {'Authorization': {'type': 'string'}}}},
    ...
    ('videos', 'GET'): {'headers': {'required': ['Authorization'], 'properties': {'Authorization': {'type': 'string'}}}, 'args': {'required': [], 'properties': {'sort': {'type': 'string', 'enum': ['+video_id', '+user_id', '-video_id', '-user_id', '+video_title', '-video_title', '+categories', '-categories', '+notes_count', '-notes_count', '+time_created', '-time_created', '+last_edited', '-last_edited'], 'default': '+video_id'}, 'video_id': {'type': 'string'}, 'user_id': {'type': 'integer'}, 'video_title': {'type': 'string'}, 'categories': {'type': 'string'}, 'notes_count': {'type': 'integer'}, 'time_created': {'type': 'integer'}, 'last_edited': {'type': 'integer'}}}},
...
filters = {
    ('logout', 'DELETE'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'message': {'type': 'string', 'example': 'successfully logged out'}}}}, 401: {'headers': None, 'schema': None}, 422: {'headers': None, 'schema': None}},
    ('login', 'POST'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'accessToken': {'type': 'string', 'example': 'fuehfoeifjw'}, 'user_id': {'type': 'integer', 'example': 1}}}}, 400: {'headers': None, 'schema': {'$ref': '#/definitions/error'}}},
    ('createAccount', 'POST'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'accessToken': {'type': 'string', 'example': 'fuehfoeifjw'}, 'user_id': {'type': 'integer', 'example': 1}}}}, 400: {'headers': None, 'schema': {'$ref': '#/definitions/error'}}},
