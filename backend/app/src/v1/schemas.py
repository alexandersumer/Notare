...
definitions = {'definitions': {'error': {'type': 'object', 'properties': {'errorMessage': {'type': 'string', 'example': 'error message'}}}, 'note': {'type': 'object', 'properties': {'note_id': {'type': 'integer', 'example': 1}, 'note': {'type': 'string', 'example': 'this is my note'}, 'user_id': {'type': 'integer', 'example': 1}, 'video_id': {'type': 'string', 'example': 'gSdG3FsMBq4'}, 'timestamp': {'type': 'number', 'example': 2.5}, 'time_created': {'type': 'integer', 'example': 1573010015}, 'last_edited': {'type': 'integer', 'example': 1573010015}}}, 'video': {'type': 'object', 'properties': {'video_id': {'type': 'string', 'example': 'https://www.youtube.com/watch?v=gSdG3FsMBq4'}, 'user_id': {'type': 'integer', 'example': 1}, 'video_title': {'type': 'string', 'example': 'physics 101'}, 'categories': {'type': 'array', 'items': {'type': 'string'}, 'example': ['education', 'comedy']}, 'time_created': {'type': 'integer', 'example': 1573010015}, 'last_edited': {'type': 'integer', 'example': 1573010015}, 'notes_ids': {'type': 'array', 'items': {'type': 'integer'}, 'example': [1, 4, 17]}, 'notes_count': {'type': 'integer', 'example': 3}}}}, 'parameters': {}}
