...
definitions = {'definitions': {'error': {'type': 'object', 'properties': {'errorMessage': {'type': 'string', 'example': 'error message'}}}, 'tag': {'type': 'object', 'properties': {'tag': {'type': 'string', 'example': 'comedy'}, 'user_id': {'type': 'integer', 'example': 1}}}, 'note': {'type': 'object', 'properties': {'note_id': {'type': 'integer', 'example': 1}, 'note': {'type': 'string', 'example': 'this is my note'}, 'user_id': {'type': 'integer', 'example': 1}, 'video_id': {'type': 'string', 'example': 'gSdG3FsMBq4'}, 'timestamp': {'type': 'number', 'example': 2.5}}}, 'video': {'type': 'object', 'properties': {'video_id': {'type': 'string', 'example': 'gSdG3FsMBq4'}, 'user_id': {'type': 'integer', 'example': 1}, 'video_title': {'type': 'string', 'example': 'physics 101'}, 'categories': {'type': 'string', 'example': 'comedy'}, 'notes_ids': {'type': 'array', 'items': {'type': 'integer'}, 'example': [1, 4, 17]}, 'notes_count': {'type': 'integer', 'example': 3}}}}, 'parameters': {}}
...
validators = {
    ...
    ('notes', 'POST'): {'json': {'type': 'object', 'properties': {'note': {'type': 'string', 'example': 'this is my note'}, 'user_id': {'type': 'integer', 'example': 1}, 'video_id': {'type': 'string', 'example': 'gSdG3FsMBq4'}, 'timestamp': {'type': 'number', 'example': 2.5}}}, 'headers': {'required': ['Authorization'], 'properties': {'Authorization': {'type': 'string'}}}},
